    ...
    <nav class="navbar navbar-expand-lg bg-transparent">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="assets/img/Logo RSIA Kasih-01 1.png" alt="Logo" width="30" class="d-inline-block align-text-top me-3">FamilyKasih</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div>
                    <a href="<?= base_url('user'); ?>"><i class="fa-solid fa-user fa-user mx-2 my-2"></i></a>
                </div>
                <div>
